...
from tldr.app import create_app
from tldr.database import db
from tldr.settings import DevConfig, ProdConfig
from tldr.user.models import User

CONFIG = ProdConfig if os.environ.get('TLDR_ENV') == 'prod' else DevConfig
